...
class VirtualBMCManager(object):
    ...
    def add(self, username, password, port, address, domain_name, **kwargs):
        # check lxc's connection and if the container exist prior to adding it
        utils.check_lxc_container(name=domain_name)
